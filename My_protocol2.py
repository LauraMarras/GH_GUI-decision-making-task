...
class DecisionMakingGui:
    ...
    1. At the beginning of each trial, you will see a cross in the middle of the screen, please try to maintain central fixation throughout the trial.
    2. Then, a stimulus will be presented, you should fixate the stimulus and withhold any response until the stimulus disappears.
    3. At stimulus offset, you will be asked to press either the W or L key on the keyboard, indicating whether the stimulus belongs to the Winning or Losing category. You will have 1 second to press the key, after which the time will expire and the trial will be lost, so try to choose as soon as possible.
    4. After you press the key (if you did it on time), you will get a feedback indicating whether you did the correct choice or not.
